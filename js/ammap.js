(function() {
    ...
    d.Class = function(a) {
        ...
        delete a.inherits) : (b.prototype.createEvents = 
        function() {
...
(function() {
    ...
    d.easeOutElastic = function(a, b, c, e, d) {
        ...
        f || (f = .3 * d);
        h < Math.abs(e) ? (h = e,
        a = f / 4) : a = f / (2 * Math.PI) * Math.asin(e / 
        h);
...
(function() {
    ...
    d.AmDraw = d.Class({
        construct: function(a, b, c, e) {
            ...
            this.container = b,
            this.addDefs(e),
            this.R = new d.SVGRenderer(this)) : d.isIE && d.VMLRenderer && 
            (d.VML = !0,
    ...
    d.SVGRenderer = d.Class({
        ...
        update: function() {
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                ...
                l = Number(l[1]),
                m = 
                0 === m - h ? m : Math.round(d[c.effect](0, g, h, m - h, e)),
                ...
                this.setAttr(f, h, c)) : ("translate" == h ? (l = c.to.split(","),
                m = Number(l[0]),
                l = Number(l[1]),
    ...
    d.AmChart = d.Class({
        ...
        measure: function() {
            ...
            if (a) {
                ...
                g && g.setSize(a, f),
                this.balloon = 
                d.processObject(this.balloon, d.AmBalloon, this.theme));
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var w = this.minWidth
                      , x = "";
                    isNaN(w) || (x = "min-width:" + (w - 2 * q) + "px; ");
                    n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + x + "max-width:" + this.maxWidth + "px; font-size:" + A + "px; color:" + this.color + "; font-family:" + 
                    v + '">' + this.text + "</div>";
                    ...
                    A = b - v - z,
                    this.deltaSignY = 1)) : (2 * z > v && (z = v / 2),
                    A = b - v / 2,
                    a < h + (l - h) / 2 ? (w = a + z,
                    this.deltaSignX = -1) : (w = a - x - z,
                    this.deltaSignX = 1));
                    A + v >= m && (A = m - v);
                    A < k && (A = k);
                    w < h && (w = h);
                    w + x > l && (w = l - x);
                    var k = A + u, m = w + q, G = this.shadowAlpha, E = this.shadowColor, q = this.borderThickness, K = this.bulletSize, J, u = this.fillAlpha, L = this.borderAlpha;
                    this.showBullet && (J = d.circle(g, K, p, u),
                    f.push(J));
                    this.drop ? (h = x / 1.6,
                    l = 0,
                    "V" == B && (B = "down"),
                    ...
                    k = A - D / 2 + 1,
                    m = w - F / 2 - 1,
                    r = d.drop(g, h, l, r, u, q, t, L)) : 0 < y || 0 === z ? (0 < G && (a = d.rect(g, x, v, r, 0, q + 1, E, 
                    G, y),
                    d.isModern ? a.translate(1, 1) : a.translate(4, 4),
                    f.push(a)),
                    r = d.rect(g, x, v, r, u, q, t, L, y)) : (p = [],
                    y = [],
                    "H" != B ? (h = a - w,
                    h > x - z && (h = x - z),
                    h < z && (h = z),
                    p = [0, h - z, a - w, h + z, x, x, 0, 0],
                    y = H ? [0, 0, b - A, 0, 0, v, v, 0] : [v, v, b - A, v, v, 0, 0, v]) : (B = b - A,
                    B > v - z && (B = v - z),
                    B < z && (B = z),
                    y = [0, B - z, b - A, B + z, v, v, 0, 0],
                    p = a < h + (l - h) / 2 ? [0, 0, w < a ? 0 : a - w, 0, 0, x, x, 0] : [x, x, w + x > a ? x : a - w, x, x, 0, 0, x]),
                    0 < G && (a = d.polygon(g, p, y, r, 0, q, E, G),
                    a.translate(1, 1),
                    f.push(a)),
                    r = d.polygon(g, p, y, r, u, q, t, L));
                    this.bg = r;
                    f.push(r);
                    r.toFront();
                    ...
                    C.left = m + "px";
                    C.top = k + "px";
                    f.translate(w - g, A, 1, !0);
                    r = r.getBBox();
                    this.bottom = A + v + 1;
                    this.yPos = r.y + A;
                    J && J.translate(this.pointToX - w + g, b - A);
...
(function() {
    ...
    d.polygon = function(a, b, c, e, g, f, h, k, l, m, n) {
        ...
        var r = e
          , t = !1;
        "object" == typeof r && 1 < r.length && (t = !0,
        r = r[0]);
        void 0 === h && (h = r);
        g = {
            fill: r,
    ...
    ;
    d.bullet = function(a, b, c, e, g, f, h, k, l, m, n, r, t) {
        var p;
        "circle" == b && (b = "round");
        switch (b) {
        case "round":
        ...
        case "square":
            ...
            break;
        case "rectangle":
            p = d.polygon(a, [-c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180, void 0, t);
            break;
        case "diamond":
        ...
        case "xError":
            p = a.set(),
            p.push(d.line(a, [-c / 2, c / 2], [0, 0], e, g, f)),
            p.push(d.line(a, [-c / 2, -c / 2], [-l, l], e, g, f)),
            p.push(d.line(a, [c / 2, c / 2], [-l, l], e, g, f))
        }
        p && p.pattern(n, NaN, r);
        return p
    ...
    d.handDrawnLine = function(a, b, c, e, g, f, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var t = [b[n - 1], b[n]], p = [c[n - 1], c[n]], p = d.makeHD(t, p, a.handDrawScatter), t = p[0], p = p[1], q = 1; q < t.length; q++)
                r.push(d.line(a, [t[q - 1], t[q]], [p[q - 1], p[q]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return r
    }
    ;
    d.doNothing = 
    ...
    d.drop = function(a, b, c, e, d, f, h, k) {
        ...
        b = "M" + n + "," + r + " A" + b + "," + b + ",0,1,1," + t + "," + p + (" A" + q + "," + q + ",0,0,0," + (Math.sin((m + 20) * l) * b + z) + "," + (Math.cos((m + 20) * l) * b + u));
        b += " A" + q + "," + q + ",0,0,0," + n + "," + r;
        return a.path(b, void 0, 
        void 0, "1000,1000").attr(c)
    }
    ;
    d.wedge = function(a, b, c, e, g, f, h, k, l, m, n, r, t, p) {
        var q = Math.round;
        f = q(f);
        h = q(h);
        k = q(k);
        ...
        var y = 1 / 180 * Math.PI
          ...
          , A = b + Math.sin(e * y) * f
          , C = c - Math.cos(e * y) * h
          , w = b + Math.sin((e + g) * y) * f
          , x = c - Math.cos((e + g) * y) * h
          , F = b + Math.sin((e + g) * y) * k
          , y = c - Math.cos((e + g) * y) * u
          , D = {
        ...
        k *= 10,
        u *= 10,
        1 > Math.abs(g) && 1 >= Math.abs(w - A) && 1 >= Math.abs(x - C) && (G = !0));
        g = "";
        var E;
        r && (D["fill-opacity"] = 0,
        D["stroke-opacity"] = m["stroke-opacity"] / 2,
        D.stroke = m.stroke);
        if (0 < l) {
            E = " M" + B + "," + (v + l) + " L" + A + "," + (C + l);
            z ? (G || (E += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + w + "," + (x + l)),
            E += " L" + F + "," + (y + l),
            0 < k && (G || (E += " B" + (b - k) + "," + (l + c - u) + "," + (b + k) + "," + 
            (l + c + u) + "," + F + "," + (l + y) + "," + B + "," + (l + v)))) : (E += " A" + f + "," + h + ",0," + H + ",1," + w + "," + (x + l) + " L" + F + "," + (y + l),
            0 < k && (E += " A" + k + "," + u + ",0," + H + ",0," + B + "," + (v + l)));
            E += " Z";
            var K = l;
            z && (K /= 10);
            for (var J = 0; J < K; J += 10) {
                var L = a.path(E, void 0, void 0, "1000,1000").attr(D);
                e.push(L);
                L.translate(0, -J)
            }
            E = a.path(" M" + B + "," + v + " L" + B + "," + (v + l) + " L" + A + "," + (C + l) + " L" + A + "," + C + " L" + B + "," + v + " Z", void 0, void 0, "1000,1000").attr(D);
            l = a.path(" M" + w + "," + x + " L" + w + "," + (x + l) + " L" + F + "," + (y + l) + " L" + F + "," + y + " L" + w + "," + x + " Z", void 0, void 0, 
            "1000,1000").attr(D);
            e.push(E);
            e.push(l)
        }
        z ? (G || (g = " A" + q(b - f) + "," + q(c - h) + "," + q(b + f) + "," + q(c + h) + "," + q(A) + "," + q(C) + "," + q(w) + "," + q(x)),
        h = " M" + q(B) + "," + q(v) + " L" + q(A) + "," + q(C) + g + " L" + q(F) + "," + q(y)) : h = " M" + B + "," + v + " L" + A + "," + C + (" A" + f + "," + h + ",0," + H + ",1," + w + "," + x) + " L" + F + "," + y;
        0 < k && (z ? G || (h += " B" + (b - k) + "," + (c - u) + "," + (b + k) + "," + (c + u) + "," + F + "," + y + "," + B + "," + v) : h += " A" + k + "," + u + ",0," + H + ",0," + B + "," + v);
        a.handDrawn && (k = d.line(a, [B, A], [v, C], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]),
        e.push(k));
        k = a.path(h + " Z", void 0, void 0, "1000,1000").attr(m);
        if (n) {
            u = [];
            for (z = 0; z < n.length; z++)
                u.push(d.adjustLuminosity(m.fill, n[z]));
            "radial" != p || d.isModern || (u = []);
            0 < u.length && k.gradient(p + "Gradient", u)
        }
        d.isModern && "radial" == p && k.grad && (k.grad.setAttribute("gradientUnits", "userSpaceOnUse"),
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (v = 0; v < B.length; v++) {
                var F = B[v];
                this.reversedOrder && (F = B[B.length - v - 1]);
                y = F.getBBox();
                var D;
                this.equalWidths ? D = A * (t + n + this.markerLabelGap) : 
                (D = C,
                C = C + y.width + f + n);
                y.height > x && (x = y.height);
                D + y.width > r && 0 < v && 0 !== A && (p++,
                D = A = 0,
                C = D + y.width + f + n,
                w = w + x + m,
                x = 0);
            ...
            if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
                "center" == this.align ? b = f + (n - y.width) / 2 : "right" == this.align && (b = f + n - y.width);
            z.translate(b, m + 1);
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)
                        ...
                        n = a.fillColorsR;
                        !0 === a.hidden && (n = e);
                        if (h = this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, p, h, a.dashLength))
                            t = m,
                            h.translate(t, m / 2);
                        n = m
                    }
                ...
                f = this.switchType;
                var u;
                f && "none" != f && 0 < m && ("x" == f ? (u = this.createX(),
                u.translate(m / 2, m / 2)) : u = this.createV(),
                u.dItem = a,
                !0 !== a.hidden ? "x" == f ? u.hide() : u.show() : "x" != f && u.hide(),
                this.switchable || u.hide(),
                this.addListeners(u, a),
                a.legendSwitch = u,
                l.push(u),
                d.setCN(b, u, "legend-switch"));
                f = this.color;
                ...
                p = this.fontSize;
                h && (m <= p && (m = m / 2 + this.ly - p / 2 + (p + 2 - m) / 2 - r,
                h.translate(t, m),
                u && u.translate(u.x, 
                m)),
                a.legendEntryWidth = h.getBBox().width);
                var z;
                e && (e = d.fixBrakes(e),
                a.legendTextReal = e,
                z = this.labelWidth,
                z = isNaN(z) ? d.text(this.container, e, f, b.fontFamily, p, "start") : d.wrappedText(this.container, e, f, b.fontFamily, p, "start", !1, z, 0),
                d.setCN(b, z, "legend-label"),
                z.translate(this.lx + n, this.ly),
                l.push(z),
                b = z.getBBox().width,
    ...
    d.AmMap = d.Class({
        ...
        initChart: function() {
            ...
            if (this.sizeChanged && d.hasSVG && this.chartCreated) {
                ...
                this.chartDiv.setAttribute("class", 
                "ammapAlert"),
        ...
        buildEverything: function() {
            if (0 < 
            this.realWidth && 0 < this.realHeight) {
                var a = this.container
                  , b = this.dataProvider;
                ...
                this.zoomControl.init(this, 
                a);
                this.drawBg();
                this.buildSVGMap();
                this.projectionFunction && c != b.projection ? (this.normalizeMap(),
        ...
        update: function() {
            d.hasSVG && (d.AmMap.base.update.call(this),
        ...
        rescaleObjects: function() {
            ...
            for (c = 0; c < b.length; c++)
                e = b[c],
                e.imageLabel && this.imagesProcessor.positionLabel(e.imageLabel, 
        ...
        handleReleaseOutside: function() {
            if (d.isModern) {
                ...
                if (!a.preventHover) {
                    ...
                    Math.abs(b.y - e)) || (a.mapWasDragged = !0,
                    b = {
                        type: "dragCompleted",
                        zoomX: a.zoomX(),
                        zoomY: a.zoomY(),
        ...
        handleMouseMove: function(a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    c = a.x + (g - c),
                    e = a.y + (f - e),
                    b.preventDragOut && (t = -t * k + m / 2,
                    m /= 2,
                    c = d.fitToBounds(c, -r * k + n / 2, n / 2),
                    e = d.fitToBounds(e, 
                    t, m)),
        ...
        selectObject: function(a, b) {
            ...
            "MapImage" == a.objectType && (h = c.imagesSettings.selectedOutlineColor,
            k = c.imagesSettings.selectedOutlineThickness,
            e = a.image);
            if (e) {
                if (d.setCN(c, e, "selected-object"),
        ...
        returnInitialColorReal: function(a) {
            ...
            if (b) {
                ...
                if (k = a.image)
                    k.setAttr("fill", c),
                    k.setAttr("stroke", h),
                    k.setAttr("stroke-width", f),
                    k.setAttr("fill-opacity", e),
                    k.setAttr("stroke-opacity", d);
        ...
        zoomToObject: function(a) {
            if (a) {
                ...
                e = g.width * f,
                g = g.height * f,
                k = a.autoZoomReal && isNaN(a.zoomLevel) ? e / k > g / l ? .8 * k / e : .8 * l / g : a.zoomLevel,
                l = this.zoomControl,
        ...
        zoomTo: function(a, b, c, e) {
            var g = this.zoomControl;
            a = d.fitToBounds(a, g.minZoomLevel, 
            g.maxZoomLevel);
            g = this.zoomLevel();
        ...
        processObjects: function() {
            ...
            if (0 < a.images.length || 0 < a.areas.length || 0 < a.lines.length || a == this.dataProvider) {
                ...
                g.toFront(),
                c.toFront());
                a && (this.imagesProcessor.reset(),
                this.linesProcessor.reset(),
                this.linesAboveImages ? (this.imagesProcessor.process(a),
                this.linesProcessor.process(a)) : (this.linesProcessor.process(a),
        ...
        rollOverMapObject: function(a, b, c) {
            if (this.chartCreated) {
                ...
                if (!this.preventHover) {
                    ...
                    this.balloonLabelFunction && (d = this.balloonLabelFunction(a, 
                    this)),
                    "MapArea" != a.objectType && (this.balloonX = NaN),
        ...
        latitudeToStageY: function(a) {
            ...
            this.zoomLevel() + this.mapContainer.y + this.diffY * this.mapScale
        },
        ...
        checkIfClickable: function(a) {
            ...
            return this.selectedObject == a && b ? !0 : this.selectedObject != a || b ? !0 === a.selectable || "MapArea" == a.objectType && a.autoZoomReal || a.url || a.linkToObject || 0 < 
            a.images.length || 0 < a.lines.length || !isNaN(a.zoomLevel) || !isNaN(a.zoomX) || !isNaN(a.zoomY) || a.description ? !0 : !1 : !1
        },
        resizeMap: function() {
            var a = this.mapSet;
            if (a) {
        ...
        mercatorLatitudeToCoordinate: function(a) {
            ...
            return d.radiansToDegrees(.5 * Math.log((1 + Math.sin(a)) / 
            (1 - Math.sin(a))) / 2)
        },
        ...
        zoomLongitude: function() {
            if (this.mapContainer) {
                var a = this.mapSet.getBBox()
                  , b = (-this.mapContainer.x + this.previousWidth / 2) / this.zoomLevel() - a.x * this.mapScale
                  , a = (-this.mapContainer.y + this.previousHeight / 
                2) / this.zoomLevel() - a.y * this.mapScale;
                ...
                for (g = 0; g < k; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)
                        if (3 == f.nodeType || 4 == f.nodeType) {
                            ...
                            var r;
                            void 0 !== a[b][l] ? void 0 === a[b][l].length ? (r = a[b][l],
                            a[b][l] = [],
                            a[b][l].push(r),
                            a[b][l].push({}),
                            r = a[b][l][1]) : 
                            "object" == typeof a[b][l] && (a[b][l].push({}),
                            r = a[b][l][a[b][l].length - 1]) : (a[b][l] = {},
                            r = a[b][l]);
        ...
        normalizeMap: function() {
            var a = 
            d.degreesToRadians(this.dataProvider.leftLongitude)
        ...
        fixMapPosition: function() {
            ...
            b = this.coordinatesToXY(d.radiansToDegrees(g), 
        ...
        xyToCoordinates: function(a, b, c, e, g) {
            ...
            if (f = c.invert) {
                ...
                k = this.dataProvider.rightLongitude
                  ...
                  , h = d.radiansToDegrees(c(d.degreesToRadians(h), d.degreesToRadians(r))[0])
                  , k = d.radiansToDegrees(c(d.degreesToRadians(k), d.degreesToRadians(r))[0]);
                this.projectionChanged && (l = d.radiansToDegrees(c(d.degreesToRadians(this.topLongLat.longitude), 
                d.degreesToRadians(this.topLongLat.latitude))[1]),
        ...
        coordinateToLatitude: function(a, b) {
            ...
            if (this.mapSet) {
                ...
                c = d.radiansToDegrees(2 * Math.atan(Math.exp(c)) - .5 * Math.PI)) : c = 
                a / b * (g - c) + c
            }
...
(function() {
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            f && (x -= q + 3 * g),
            x = h ? x - 3 * g : c.homeButtonEnabled ? x - .5 * g : x + g);
            e.translate(w, x);
            c.previousDY = NaN;
            var F, w = g / 4 - 1;
            if (f) {
                ...
                c.set = e;
                c.zoomSet = F;
                5 < q && (f = d.rect(b, g + 6, q + 2 * g + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, 0, 0, 4),
                d.setCN(a, f, "zoom-bg"),
                f.translate(-3, -3),
                f.mouseup(function() {
                    c.handleBgUp()
                ...
                A && (D = g / 1.5);
                c.draggerSize = D;
                var H = Math.log(B / z) / Math.log(u) + 1;
                1E3 < H && (H = 1E3);
                var f = q / H, G, E = b.set();
                E.translate((g - D) / 2 + 1, 1, NaN, !0);
                F.push(E);
                for (G = 1; G < H; G++)
                    x = g + G * f,
                    x = d.line(b, [1, D - 2], [x, x], c.gridColor, c.gridAlpha, 1),
                    d.setCN(a, x, "zoom-grid"),
                    E.push(x);
                x = new d.SimpleButton;
                x.setDownHandler(c.draggerDown, c);
                x.setClickHandler(c.draggerUp, c);
                x.init(b, D, f, k, l, m, n, r, t, p);
                d.setCN(a, x.set, "zoom-dragger");
                F.push(x.set);
                ...
                x = new d.SimpleButton;
                C ? (D = b.set(),
                H = d.line(b, [-w, w], [0, 0], v, y, 1),
                G = d.line(b, [0, 0], [-w, w], v, y, 1),
                D.push(H),
                D.push(G),
                x.svgIcon = D) : x.setIcon(a.pathToImages + "plus.gif", c.iconSize);
                x.setClickHandler(a.zoomIn, a);
                x.init(b, g, g, k, l, m, n, r, t, p, y, v, A);
                d.setCN(a, x.set, "zoom-in");
                F.push(x.set);
                x = new d.SimpleButton;
                C ? x.svgIcon = d.line(b, [-w, w], [0, 0], v, y, 1) : x.setIcon(a.pathToImages + "minus.gif", c.iconSize);
                x.setClickHandler(a.zoomOut, a);
                x.init(b, g, g, k, l, m, n, r, t, p, y, v, A);
                x.set.translate(0, q + g);
                d.setCN(a, x.set, "zoom-out");
                F.push(x.set);
                q -= f;
                B = Math.log(B / 100) / Math.log(u);
                c.realStepSize = q / (B - Math.log(z / 100) / Math.log(u));
                c.realGridHeight = q;
                c.stepMax = B
            }
            h && (h = b.set(),
            ...
            C ? u.svgIcon = d.line(b, [w / 5, -w + w / 5, 
            w / 5], [-w, 0, w], v, y, 1) : u.setIcon(a.pathToImages + "panLeft.gif", c.iconSize),
            u.setClickHandler(a.moveLeft, a),
            u.init(b, g, g, k, l, m, n, r, t, p, y, v, A),
            u.set.translate(0, g),
            d.setCN(a, u.set, "pan-left"),
            h.push(u.set),
            u = new d.SimpleButton,
            C ? u.svgIcon = d.line(b, [-w / 5, w - w / 5, -w / 5], [-w, 0, w], v, y, 1) : u.setIcon(a.pathToImages + "panRight.gif", c.iconSize),
            u.setClickHandler(a.moveRight, a),
            u.init(b, g, g, k, l, m, n, r, t, p, y, v, A),
            u.set.translate(2 * g, g),
            d.setCN(a, u.set, "pan-right"),
            h.push(u.set),
            u = new d.SimpleButton,
            C ? u.svgIcon = d.line(b, 
            [-w, 0, w], [w / 5, -w + w / 5, w / 5], v, y, 1) : u.setIcon(a.pathToImages + "panUp.gif", c.iconSize),
            u.setClickHandler(a.moveUp, a),
            u.init(b, g, g, k, l, m, n, r, t, p, y, v, A),
            u.set.translate(g, 0),
            d.setCN(a, u.set, "pan-up"),
            h.push(u.set),
            u = new d.SimpleButton,
            C ? u.svgIcon = d.line(b, [-w, 0, w], [-w / 5, w - w / 5, -w / 5], v, y, 1) : u.setIcon(a.pathToImages + "panDown.gif", c.iconSize),
            u.setClickHandler(a.moveDown, a),
            u.init(b, g, g, k, l, m, n, r, t, p, y, v, A),
            u.set.translate(g, 2 * g),
            d.setCN(a, u.set, "pan-down"),
            h.push(u.set),
            e.push(h));
            c.homeButtonEnabled && (h = new d.SimpleButton,
            C ? h.svgIcon = d.polygon(b, [-w, 0, w, w - 1, w - 1, 2, 2, -2, -2, -w + 1, -w + 1], [0, -w, 0, 0, w - 1, w - 1, 2, 2, w - 1, w - 1, 0], v, y, 1, v, y) : h.setIcon(a.pathToImages + c.homeIconFile, c.iconSize),
            h.setClickHandler(a.goHome, a),
            c.panControlEnabled && (r = l = 0),
            h.init(b, g, g, k, l, m, n, r, t, p, y, v, A),
            c.panControlEnabled ? h.set.translate(g, g) : F && F.translate(0, 1.5 * g),
        ...
        update: function() {
            ...
            f = e.y + (h.mouseY - this.previousY),
            f = d.fitToBounds(f, g, this.realGridHeight + g),
            h.zoomTo(100 * Math.pow(a, c - (f - g) / b), NaN, NaN, !0)) : (a = Math.log(h.zoomLevel() / 100) / Math.log(a),
            f = (c - a) * b + g),
            this.previousY = 
            h.mouseY,
...
(function() {
    ...
    d.SimpleButton = d.Class({
        ...
        init: function(a, b, c, e, g, f, h, k, l, m, n, r, t) {
            ...
            p.set = m;
            t ? (b /= 2,
            e = d.circle(a, b, e, g, f, h, k),
            e.translate(b, b)) : e = d.rect(a, b, c, e, g, f, h, k, l);
            m.push(e);
            g = p.iconPath;
            var q;
            g && (q = p.iconSize,
    ...
    d.SmallMap = d.Class({
        ...
        init: function(a, b) {
            ...
            if (c.enabled) {
                ...
                a.svgIcons ? n.svgIcon = d.line(b, [-r / 2, 0, r / 2], [-r / 4, r / 4, -r / 
...
(function() {
    ...
    d.AreasProcessor = d.Class({
        ...
        process: function(a) {
            ...
            for (d = 0; d < c; d++)
                g = a[d],
                isNaN(g.value) ? g.percents = void 0 : (g.percents = (g.value - k) / f * 100,
                k == h && (g.percents = 100));
            for (d = 0; d < c; d++)
                g = a[d],
                this.createArea(g)
        ...
        createArea: function(a) {
            ...
            var f = e.color
              ...
              , u = e.selectable
              , z = e.pattern
              , B = e.rollOverOutlineColor
              , y = e.bringForwardOnHover
            ...
            a.enTitle = c.title,
            y && !a.title && (a.title = y),
            (c = b.language) ? (y = d.mapTranslations) && (c = y[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0,
            r)) {
                a.displayObject = r;
                ...
                e.adjustOutlineThickness && (p = p / b.zoomLevel() / b.mapScale);
                a.preserveOriginalAttributes || (r.setAttr("fill", C),
                r.setAttr("stroke", f),
                r.setAttr("stroke-opacity", t),
                r.setAttr("stroke-width", p),
                r.setAttr("fill-opacity", A));
...
(function() {
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function(a, b) {
            ...
            if (F) {
                ...
                if ("circle" == F || "bubble" == F)
                    D = C;
                E = this.createPredefinedImage(G, t, p, F, C, D);
                q = y = 0;
                a.centeredReal ? (isNaN(a.right) || (y = C * n),
                isNaN(a.bottom) || (q = D * n)) : (y = C * n / 2,
                q = D * n / 2);
                E.translate(y, q, n, !0)
            } else
                B ? (isNaN(C) && (C = 10),
                isNaN(D) && (D = 10),
                E = e.image(B, 0, 0, C, D),
                E.node.setAttribute("preserveAspectRatio", "none"),
                E.setAttr("opacity", k),
                a.centeredReal && (y = isNaN(a.right) ? -C / 2 : C / 2,
                q = isNaN(a.bottom) ? -D / 2 : D / 2,
                E.translate(y, q, NaN, !0))) : z && (E = e.path(z),
                F = E.getBBox(),
                a.centeredReal ? (y = -F.x * n - 
                F.width * n / 2,
                isNaN(a.right) || (y = -y),
                q = -F.y * n - F.height * n / 2,
                isNaN(a.bottom) || (q = -q)) : y = q = 0,
                E.translate(y, q, n, !0),
                E.x = y,
                E.y = q);
            E && (H.push(E),
            a.image = E,
            E.setAttr("stroke-opacity", l),
            E.setAttr("stroke-width", p),
            E.setAttr("stroke", t),
            E.setAttr("fill-opacity", k),
            E.setAttr("fill", G),
            d.setCN(c, E, "map-image"),
            void 0 != a.id && d.setCN(c, E, "map-image-" + a.id));
            G = a.labelColorReal;
            !a.showAsSelected && c.selectedObject != a || void 0 == h || (E.setAttr("fill", h),
            G = a.selectedLabelColorReal);
            E = null ;
            void 0 !== a.label && (E = d.text(e, 
            a.label, G, c.fontFamily, a.labelFontSizeReal, a.labelAlign),
            d.setCN(c, E, "map-image-label"),
            void 0 !== a.id && d.setCN(c, E, "map-image-label-" + a.id),
            G = a.labelBackgroundAlpha,
            (k = a.labelBackgroundColor) && 0 < G && (l = E.getBBox(),
            ...
            a.lineId && (E = this.chart.getObjectById(a.lineId)) && 0 < E.longitudes.length && (e = !1);
            e ? f.push(H) : g.push(H);
        ...
        updateSizeAndPosition: function(a) {
            ...
            var n = a.imageLabel, r = this.chart.zoomLevel(), t, p;
            if (a.lineId) {
                var q = this.chart.getObjectById(a.lineId);
                (a.line = q) && q.getCoordinates && (q.chart = b,
                q = q.getCoordinates(m, a.lineSegment)) && (k = b.coordinateToLongitude(q.x),
                l = b.coordinateToLatitude(q.y),
                t = q.x,
                p = q.y,
                f = d.radiansToDegrees(q.angle))
            }
            isNaN(f) || c.rotate(f + a.extraAngle);
            if (!isNaN(e) && !isNaN(g))
                c.translate(e, g, NaN, !0);
            else if (!isNaN(l) && !isNaN(k))
                if (g = b.coordinatesToXY(k, l),
                e = g.x,
                g = g.y,
                isNaN(t) || (e = t),
                isNaN(p) || (g = p),
                a.fixedSize) {
                    ...
                    c.translate(e, g, t / r + b, !0)
                } else
                    c.translate(e, 
                    g, NaN, !0),
                    n && (this.labelsToReposition.push(a),
                    a.arrays.push({
        ...
        positionLabel: function(a, b, c) {
            if (a) {
                ...
                f += k / 2);
                a.translate(g + 
                b.labelShiftX, f + b.labelShiftY, NaN, !0);
        ...
        createPredefinedImage: function(a, b, c, e, g, f) {
            ...
            case "hexagon":
                g /= Math.sqrt(3),
                k = d.polygon(h, [.866 * g, 0 * g, -.866 * g, -.866 * g, 0 * g, .866 * g], [.5 * g, 
                1 * g, .5 * g, -.5 * g, -1 * g, -.5 * g], a, 1, c, b, 1)
            }
            return k
        },
        reset: function() {
...
(function() {
    ...
    d.LinesProcessor = d.Class({
        ...
        createLine: function(a, b) {
            ...
            a.mouseEnabled && c.addObjectEventListeners(x, 
            a);
                ...
                if (0 < v.length) {
                    ...
                    if (isNaN(n)) {
                        for (n = 0; n < v.length - 1; n++)
                            H = Math.sqrt(Math.pow(v[n + 1] - v[n], 2) + Math.pow(C[n + 1] - C[n], 2)),
                            a.distances[n] = H;
                        n = d.line(w, v, C, l, 1, F, k, !1, !1, !0);
                        l = d.line(w, v, C, l, .001, 5, k, !1, !1, !0)
                    } else {
                        q = 1;
                        0 > y && (q = 0);
                        B = {
                        ...
                        for (z = 0; z < v.length - 1; z++) {
                            var E = v[z]
                              ...
                              , J = C[z]
                              , L = C[z + 1];
                            H = Math.sqrt(Math.pow(K - E, 2) + Math.pow(L - J, 2));
                            G = H / 2 * n;
                    ...
                    void 0 != 
                    a.id && d.setCN(c, n, "map-line-" + a.id);
                    d.dx = .5;
                    d.dy = .5;
                    x.push(n);
                    x.push(l);
                    ...
                    if ("none" != A) {
                        ...
                        if ("end" == A || "both" == A)
                            p = v[v.length - 1],
                            q = C[C.length - 1],
                            1 < v.length ? (k = v[v.length - 2],
                            I = C[C.length - 2]) : (k = p,
                            I = q),
                            I = 180 * Math.atan((q - I) / (p - k)) / Math.PI,
                            isNaN(D) || (I += D),
                            M = p,
                            N = q,
                            I = 0 > p - k ? I - 90 : I + 90;
                        "both" == A && (p = d.polygon(w, [-t / 2, 0, t / 2], [1.5 * t, 0, 1.5 * t], m, r, 1, m, r),
                        x.push(p),
                        p.translate(M, N, 1, !0),
                        isNaN(I) || p.rotate(I),
                        d.setCN(c, n, "map-line-arrow"),
                        void 0 != a.id && d.setCN(c, n, "map-line-arrow-" + 
                        a.id),
                        a.fixedSize && g.push(p));
                        if ("start" == A || "both" == A)
                            p = v[0],
                            N = C[0],
                            1 < v.length ? (k = v[1],
                            M = C[1]) : (k = p,
                            M = N),
                            I = 180 * Math.atan((N - M) / (p - k)) / Math.PI,
                            isNaN(D) || (I -= D),
                            M = p,
                            I = 0 > p - k ? I - 90 : I + 90;
                        "middle" == A && (p = v[v.length - 1],
                        q = C[C.length - 1],
                        1 < v.length ? (k = v[v.length - 2],
                        I = C[C.length - 2]) : (k = p,
                        I = q),
                        ...
                        I = 0 > p - k ? I - 90 : I + 90);
                        p = d.polygon(w, 
                        [-t / 2, 0, t / 2], [1.5 * t, 0, 1.5 * t], m, r, 1, m, r);
                        d.setCN(c, n, "map-line-arrow");
                    ...
                    a.lineSvg = n;
                    a.showAsSelected && !isNaN(u) && n.setAttr("stroke", 
                    u);
                    0 < e.length ? f.push(x) : h.push(x);
                    a.hidden && x.hide()
                }
            }
        },
    ...
    d.MapLine = d.Class({
        ...
        getCoordinates: function(a, b) {
            ...
            if (!isNaN(a)) {
                ...
                f = this.chart.coordinatesToXY(this.longitudes[b + 1], this.latitudes[b + 1]),
                c = e.x,
                g = f.x,
                e = e.y,
                f = f.y) : 1 < this.x.length && (c = this.x[b],
                g = this.x[b + 1],
                e = this.y[b],
                f = this.y[b + 1]);
...
(function() {
    ...
    d.MapImage = d.Class({
        ...
        animate: function() {
            ...
            c = 1;
            a.line && b.adjustAnimationSpeed && (a.line.distances && (c = a.line.distances[a.lineSegment] * a.chart.zoomLevel(),
            c = Math.abs(c / b.baseAnimationDistance)),
            a.totalFrames = Math.round(c * 
            a.totalFrames));
            a.frame = 0;
            a.clearTO();
        ...
        update: function() {
            ...
            -1 == a.direction && (e = 
            1 - e),
            a.animatingAlong ? a.positionOnLine = e : (c = a.initialX + (a.finalX - a.initialX) * e,
            isNaN(a.longitude) || (a.longitude = c),
            isNaN(a.left) || (a.left = c),
            isNaN(a.right) || (a.right = c),
            e = a.initialY + (a.finalY - a.initialY) * e,
            isNaN(a.latitude) || (a.latitude = e),
            isNaN(a.top) || (a.top = e),
            isNaN(a.bottom) || (a.bottom = e)),
            a.clearTO(),
            ...
            a.animatingAlong && (1 == a.direction ? a.lineSegment < a.line.segments - 2 ? (a.lineSegment++,
            a.delayAnimateAlong(),
            a.positionOnLine = 0) : a.flipDirection ? (a.direction = -1,
            a.extraAngle = 180,
            a.delayAnimateAlong()) : a.loop && (a.delayAnimateAlong(),
            a.lineSegment = 0) : 0 < a.lineSegment ? (a.lineSegment--,
            a.delayAnimateAlong(),
            a.positionOnLine = 0) : a.loop && a.flipDirection ? (a.direction = 1,
            a.extraAngle = 0,
            a.delayAnimateAlong()) : a.loop && a.delayAnimateAlong()))
        },
...
(function() {
    ...
    d.winkel3.invert = function(a, b) {
        ...
        do
            ...
            l = Math.sin(2 * e), m = k * k, n = h * h, r = Math.sin(c), t = Math.cos(c / 2), p = Math.sin(c / 2), q = p * p, u = 1 - n * t * t, z = u ? d.acos(h * t) * Math.sqrt(B = 1 / u) : B = 0, B, u = .5 * (2 * z * h * p + c / f) - a, y = .5 * (z * k + e) - b, v = .5 * B * (n * q + z * h * t * m) + .5 / f, A = B * (r * l / 4 - z * k * p), k = .125 * B * (l * p - z * k * n * r), m = .5 * B * (m * t + z * q * h) + .5, h = A * k - m * v, A = (y * A - u * m) / h, u = (u * k - y * v) / h, c = c - A, e = e - u;
        while ((1E-6 < Math.abs(A) || 1E-6 < Math.abs(u)) && 0 < --g);return [c, e]
    }
    ;
        ...
        init: function(a, b) {
            if (this.enabled) {
                ...
                if (this.showAsGradient)
                    ...
                    [c, e], 1, this.borderThickness, this.borderColor, 1, 0, 0),
